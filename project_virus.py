...
file_path= input(colorama.Fore.YELLOW + 'Enther the path of the file >>')
params = {'apikey': api}
...
for key,values in result.items():
        ...
        if verdict == 'undetected':
                ...
                verdict = colorama.Fore.YELLOW + 'type-unsupported'
...
if malicious_count !=0:
        type(colorama.Back.WHITE + colorama.Fore.RED + f'\t\t\t\t{malicious_count} antivirus found said files malicious')
elif malicious_count ==0:
        type(colorama.Back.WHITE + colorama.Fore.GREEN + f'\t\t\t\t The antivirus found said files as not malicious')
